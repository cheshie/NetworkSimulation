...
# # # # # # # # # # # # # # # # # # # # # # # # # # # 
# # # # # # # # # # # # # # # # # # # # # # # # # # # 
eventTpl_scheme = namedtuple('event_tuple', ["event", "time", "sendnode", "dest", 
    "dummy1", "size", "dummy2", "flow", "dummy3", "dummy4", "dummy5", "dummy6"])
...
def checkevent(eventpl):
    ...
    if eventpl.event == "-" and eventpl.sendnode == SEND_NODE and eventpl.dest == DEST_NODE \
