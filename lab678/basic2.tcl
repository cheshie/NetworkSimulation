...
# This is the parameter for lab6 and 7. Just pass cmd param and change it from 0 to 110 etc
set delayB $argv
...
# set outstr [format "parameters: delayB=%f" $delayB]
# puts stdout $outstr
...
proc finish {} {
        ...
        set outstr [format "delayB=%f rttr2=%f goodput_r=%f " $delayB $rttratio2 $actualratio]
        puts stdout $outstr
        $ns flush-trace
        close $trace
        exit 0
